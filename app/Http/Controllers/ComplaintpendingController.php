...
use App\Models\complaintpending;
...
class ComplaintpendingController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $data = complaintpending::where('complaint_fir_id', $complaint_fir_id)
        ...
        return view('frontend.PendingComplaint', compact('data','complaintstypes'));
    }
     ...
     */
    public function show(complaintpending $complaintpending)
    {
        //
    }
     ...
     */
    public function edit(complaintpending $complaintpending)
    {
        //
    }
    ...
    {
        $record = complaintpending::find($id);
     ...
     */
    public function destroy(complaintpending $complaintpending)
    {
        //
    }
}
